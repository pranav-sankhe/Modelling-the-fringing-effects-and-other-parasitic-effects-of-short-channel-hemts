...
### The semiconductor usually used is silicon. Better semiconductors like gallium arsenide are not preferred since they fail to provide good insulating interfaces**.**

### **Working:**

When a voltage is applied between gate and body terminal a channel is formed at the semiconductor oxide(insulator) interface which serves the purpose of conducting charge carriers from source to drain terminals. By controlling the voltage we can control the current flowing between the source and drain. By changing the voltage what we change is the conductivity of the channel and thus changing the current.
...
### **Now let’s discuss about the capacitance of the mosfet :**
...
When we go to nano scale this the fringing effects that are ignored at normal dimensions come to picture and significantly affect the performance of this devices.

**So let’s study this effects :**
...
**![HEMT-band_structure_scheme-en.svg.png](https://lh5.googleusercontent.com/dBI0EmkIKRQDIcZeguarutrDqg2lXy1KcJDEaweTsihvKe18-tV9Wrc4zATSFwInCrQuDJPhyBQaSuCO5MwDCrUtDMOvS8DU1kp4SmP76lzbA6kIgnSi42Cq8TfwN9ZG7fMS8UvB)**

Now we will analyse fringing effects and other parasitic effects in hemts.

Let's see what is the significance of these parasitic effects on the performance of hemts.
